...
body.login1 {
    background: url(__PUBLIC__/se7en/images/login_onepunch_bg.jpg) no-repeat center center;
  ...
  <body class="login1">
    ...
    <div class="login-wrapper">
      ...
      <div class="login-container">
        ...
        <a href="index.html"><img width="170"  src="__PUBLIC__/se7en/images/pxtar-logo.png" /></a>

        <form action="<?php echo U('login','',false);?>" method="POST">

          <div class="form-group">

            <input class="form-control" placeholder="账户" type="text" name="usr">

          </div>

          <div class="form-group">

            <input class="form-control" placeholder="密码" type="Password" name="pwd"><input type="submit" value="&#xf054;">
